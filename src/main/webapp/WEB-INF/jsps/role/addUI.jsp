...
<body> 
  ...
  <form action="/microCourse/admin/role/add" method="post">
  	<div style="float: left;">
	角色名称:<input type="text" class="form-control" name="name" placeholder="输入角色名称" style="width: 300px"><br>
	角色說明:<textarea class="form-control" name="description" rows="3" placeholder="输入角色描述" style="width: 300px"></textarea><br>
	</div>
	<!-- 表单内容显示 -->
