define(function(require,exports){
	...
	require("/microCourse/resources/lib/dot/1.0.0/doT.js");
	var tpl=require("/microCourse/resources/template/note-list.tpl");
	var page=require("/microCourse/resources/component/base/util/paging.js");
	var settings,
		pageRander,
		$itemContainer,
		$pageContainer,
	...
	function note(options){
		...
		$(document).off("click.imagetoggle").on("click.imagetoggle",".answerImg",function(e){
			if($(e.target).hasClass('seevideo')){
				return ;
			}
			if($(e.target).hasClass('seepic')){
				$(this).closest('.answerImg').hide().siblings(".answerImg").show();
			}else{
