define(function(require, exports, module){
	...
	require('/microCourse/resources/lib/jquery/plugin/jquery.scrollbar');
	require('/microCourse/resources/css/jquery.scrollbar.css');
	require('/microCourse/resources/component/base/placeholder/placeholder.js');
	require('jwplayer');
	require('/microCourse/resources/page/course/common/autocomplete.js');
...
$(function(){
	...
	var GetListData={
		pl:require("/microCourse/resources/page/course/common/ajax-pl-list.js")({
			container:$('#plLoadListData'),
			params:{
				mid:pageInfo.mid
			}
		}),
		mate:require("/microCourse/resources/page/course/common/ajax-otherscode-list.js")({
			container:$('#mateLoadListData'),
			params:{
				mid:pageInfo.mid
			}
		}),
		qa:require("/microCourse/resources/page/course/common/ajax-discuss-list.js")({
			container:$('#qaLoadListData'),
			params:{
				mid:pageInfo.mid
			}
		}),
		note:require("/microCourse/resources/page/course/common/ajax-note-list.js")({
		...
		wiki:require("/microCourse/resources/page/course/common/ajax-wiki-list.js")({
	...
	(function(){
		var ue=UE.getEditor("discuss-editor",{initialFrameHeight:160,autoHeight: true,autoFloatEnabled:false,autoClearinitialContent:true,initialStyle:'p{line-height:1.5em;font-size:13px;color:#444}'});
		ue.ready(function() {
			//设置编辑器的内容
			//ue.setContent('hello');
			//ue.focus();
...
////分享
var chaptername=$(".section-list h3").text();   //章名称
