define(function(require, exports, module){
    ...
    require('/microCourse/resources/lib/jquery/plugin/jquery.progress');
    require('/microCourse/resources/lib/jquery/plugin/jquery.scrollbar');
    require('/microCourse/resources/css/jquery.scrollbar.css');
    require('/microCourse/resources/page/course/common/raphael.js');
    ...
    function initReportChart(data){
        seajs.use('/microCourse/resources/lib/echarts/echarts.js', function(){
