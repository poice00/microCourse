 ...
 * UEditor
 * version: ueditor
 * build: Fri Mar 20 2015 13:33:59 GMT+0800 (中国标准时间)
 */
    ...
    return {
        ...
        bindEvents:{
            ...
            'contentchange': function () {
                ...
                if ( !saveKey || !me.options.enableAutoSave) {
                    return;
                }
...
(function () {
    ...
    Popup.prototype = {
        ...
        fitSize: function (){
            ...
            popBodyEl.style.height = -(-5 - size.height) + 'px';
            this.__size = size;
...
(function () {
    ...
    var btnCmds = ['undo', 'redo', //'formatmatch',
        ...
        //'selectall', 'print','horizontal', 'removeformat', 'time', 'date',
        'unlink',
...
(function () {
    ...
    UE.ui.Editor = function (options) {
        ...
        editor.on('focus', function(){
            editor.container.style.borderColor = '#888';
        });
        editor.on('blur', function(){
            editor.container.style.borderColor = '';
        });
        return editor;
    };
