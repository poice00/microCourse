    ...
    <li class="pl-list clearfix">
      ...
      <div class="pl-list-main">
        ...
        <div class="pl-list-btm clearfix">
          ...
          {{?pl.is_support>0}} 
            <a title="赞" href="javascript:;" class="list-praise on r" data-id="{{=pl.id}}"><i class="icon-thumb on"></i>
          {{??}}
            <a title="赞" href="javascript:;" class="js-pl-praise list-praise r" data-id="{{=pl.id}}"><i class="icon-thumb"></i>
          {{?}}
