<ul>    
    ...
    <li class="clearfix othercode-item" >
      ...
      <div class="otherscode-list-bottom r"> 
        ...
        {{?notes.has_support>0}} 
          <a title="赞" href="javascript:;" class="list-praise on" data-id="{{=notes.id}}"><span class="icon-thumb on"></span>
        {{??}}
          <a title="赞" href="javascript:;" class="js-otherscode-praise list-praise " data-id="{{=notes.id}}"><span class="icon-thumb"></span>
        {{?}}
