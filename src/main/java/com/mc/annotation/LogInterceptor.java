...
public class LogInterceptor  {
    ...
    //Controller层切点    
    @Pointcut("@annotation(com.mc.annotation.SystemControllerLog)")    
	...
	public LogInterceptor() {
		System.out.println("初始化切面管理员日志记录...");
	}
...
//	 @Before("execution(* com.ssy.controller.*.*(..))")
	    ...
	    public void afterMethod(JoinPoint point) {
	        ...
	        String ip = request.getRemoteAddr();  
	         try {  
	        	...
	        	String opContent = optionContent(arguments);  
	 ...
	 /** 
	     ...
	     */  
	      ...
	      * @return
	      */
	     public static String optionContent(Object[] args){
	       if(args == null){
	         return null;
	       }
